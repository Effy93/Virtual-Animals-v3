...
// Returns the private 'App\Repository\AttaqueRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/AttaqueRepository.php';

return $this->privates['App\Repository\AttaqueRepository'] = new \App\Repository\AttaqueRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
