...
// Returns the private 'App\Repository\AccessoireRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/AccessoireRepository.php';

return $this->privates['App\Repository\AccessoireRepository'] = new \App\Repository\AccessoireRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
