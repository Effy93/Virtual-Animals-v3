...
// Returns the private 'App\Repository\ElementRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ElementRepository.php';

return $this->privates['App\Repository\ElementRepository'] = new \App\Repository\ElementRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
