...
// Returns the private 'App\Repository\RaceRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/RaceRepository.php';

return $this->privates['App\Repository\RaceRepository'] = new \App\Repository\RaceRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
