...
// Returns the private 'App\Repository\MonstreRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/MonstreRepository.php';

return $this->privates['App\Repository\MonstreRepository'] = new \App\Repository\MonstreRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
