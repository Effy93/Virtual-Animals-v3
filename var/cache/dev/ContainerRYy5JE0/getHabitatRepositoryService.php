...
// Returns the private 'App\Repository\HabitatRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/HabitatRepository.php';

return $this->privates['App\Repository\HabitatRepository'] = new \App\Repository\HabitatRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
