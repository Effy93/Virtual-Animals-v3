...
// Returns the private 'App\Repository\ClasseRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ClasseRepository.php';

return $this->privates['App\Repository\ClasseRepository'] = new \App\Repository\ClasseRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
